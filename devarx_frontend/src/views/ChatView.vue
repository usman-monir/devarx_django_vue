                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4">
                                <img :src="getOtherUser(conversation.users).get_avatar" class="w-[40px] h-[40px] rounded-full">
                ...
                <div class="flex flex-col flex-grow p-4">
                    <div v-if="activeConversation" v-for="message in activeConversation.messages"
                        ...
                        <div v-else class="flex w-full mt-2 space-x-3 max-w-md">
                            <div class="flex-shrink-0 h-10 w-10 rounded-full bg-gray-300">
                                <img :src="message.sent_by.get_avatar" class="w-[40px] h-[40px] rounded-full">
                            </div>
                            <div>
